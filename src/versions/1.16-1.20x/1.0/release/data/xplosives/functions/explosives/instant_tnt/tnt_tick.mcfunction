execute as @e[type=bat,tag=custom_tnt,tag=instant_tnt] if entity @s at @s align xz run summon armor_stand ~0.5 ~ ~0.5 {Marker:1b,Invisible:1b,Invulnerable:1b,NoGravity:1b,Tags:["custom_tnt","instant_tnt"]}
