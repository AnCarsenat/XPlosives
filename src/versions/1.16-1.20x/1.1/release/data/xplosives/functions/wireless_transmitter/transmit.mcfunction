...
tag @s add emitter
tellraw @s ["",{"text":"entity : ","color":"gold"},{"selector":"@e[tag=emitter]"},{"text":" emitted on : ","color":"gold"},{"score":{"name":"@a[tag=emitter]","objective":"xplosives.s.chnl"}}]
...
execute as @e[type=armor_stand,tag=wireless_transmitter,tag=receiver,tag=received] run tellraw @a[tag=emitter] ["",{"text":"detonated : ","color":"gold"},{"selector":"@s","color":"dark_gray"},{"text":" at : ","color":"gold"},{"nbt":"Pos","entity":"@s","color":"dark_gray"},{"text":" on channel : ","color":"gold"},{"score":{"name":"@s","objective":"xplosives.s.chnl"},"color":"dark_gray"}]
